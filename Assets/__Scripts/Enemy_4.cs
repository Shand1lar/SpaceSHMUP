 ...
 public class Enemy_4 : Enemy {            // Enemy_4 also extends the Enemy class[Header("Enemy_4 Inscribed Fields")]
     ...
     public AudioClip deathSound; // Declare a public AudioClip variable to hold the hit sound effect    // a
     public GameObject explosion; // Declare a public GameObject variable to hold the explosion prefab    // b
     void Start() {
         ...
         AudioSource audioSource = GetComponent<AudioSource>(); // Get the AudioSource component on the Enemy_4
         if (audioSource != null && audioSource.clip != null) { // Check if audioSource and its clip are not null
         ...
         if ( p != null ) {
             ...
             if ( bndCheck.isOnScreen ) {
                ...
                if (explosion != null) {
                        ...
                        Vector3 fixedPos = expo.transform.position;
                        fixedPos.z = 0;
